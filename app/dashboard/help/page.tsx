    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-2">
            <li><strong className="text-foreground text-[var(--color-income)]">Income</strong> - Money coming in (salary, freelance, investments)</li>
            <li><strong className="text-foreground text-[var(--color-expense)]">Expense</strong> - Money going out (rent, groceries, entertainment)</li>
            <li><strong className="text-foreground text-[var(--color-transfer)]">Savings</strong> - Money set aside for future use</li>
          </ul>
        </div>
        <div className="p-3 bg-[var(--color-warning)]/10 border border-[var(--color-warning)]/20 rounded-lg">
          <h4 className="font-medium text-[var(--color-warning)] mb-2">Setting Up Categories for Budgets</h4>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-2">
            <li><strong className="text-foreground text-[var(--color-income)]">Income</strong> - Money received (salary, refunds, gifts)</li>
            <li><strong className="text-foreground text-[var(--color-expense)]">Expense</strong> - Money spent (purchases, bills, subscriptions)</li>
            <li><strong className="text-foreground text-[var(--color-transfer)]">Transfer</strong> - Money moved between your accounts</li>
          </ul>
        </div>
        <div className="space-y-3">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="p-3 bg-[var(--color-warning)]/10 border border-[var(--color-warning)]/20 rounded-lg">
          <h4 className="font-medium text-[var(--color-warning)] mb-2">No Budget Suggestions?</h4>
          <p className="text-sm text-muted-foreground">
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="p-3 bg-[var(--color-info)]/10 border border-[var(--color-info)]/20 rounded-lg">
          <h4 className="font-medium text-[var(--color-info)] mb-2">Import Tips</h4>
          <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-2">
