...
CREATE TABLE "sales_tax_settings" ("id" text PRIMARY KEY NOT NULL, "user_id" text NOT NULL, "household_id" text NOT NULL, "default_rate" double precision DEFAULT 0 NOT NULL, "jurisdiction" text, "fiscal_year_start" text, "filing_frequency" text DEFAULT 'quarterly', "enable_tracking" boolean DEFAULT true, "state_rate" double precision DEFAULT 0, "county_rate" double precision DEFAULT 0, "city_rate" double precision DEFAULT 0, "special_district_rate" double precision DEFAULT 0, "state_name" text, "county_name" text, "city_name" text, "special_district_name" text, "created_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'), "updated_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'));--> statement-breakpoint
...
CREATE TABLE "sales_tax_categories" ("id" text PRIMARY KEY NOT NULL, "user_id" text NOT NULL, "household_id" text NOT NULL, "name" text NOT NULL, "rate" double precision NOT NULL, "description" text, "is_default" boolean DEFAULT false, "is_active" boolean DEFAULT true, "created_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'), "updated_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'));--> statement-breakpoint
...
CREATE TABLE "quarterly_filing_records" ("id" text PRIMARY KEY NOT NULL, "user_id" text NOT NULL, "household_id" text NOT NULL, "tax_year" integer NOT NULL, "quarter" integer NOT NULL, "due_date" text NOT NULL, "submitted_date" text, "status" text DEFAULT 'pending', "total_sales_amount" double precision DEFAULT 0, "total_tax_amount" double precision DEFAULT 0, "amount_paid" double precision DEFAULT 0, "balance_due" double precision DEFAULT 0, "notes" text, "created_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'), "updated_at" text DEFAULT to_char((now() AT TIME ZONE 'utc'), 'YYYY-MM-DD\"T\"HH24:MI:SS.MS\"Z\"'));--> statement-breakpoint
