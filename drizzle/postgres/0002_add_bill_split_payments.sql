ALTER TABLE bills ADD COLUMN IF NOT EXISTS split_across_periods BOOLEAN DEFAULT false;--> statement-breakpoint
ALTER TABLE bills ADD COLUMN IF NOT EXISTS split_allocations TEXT;--> statement-breakpoint
