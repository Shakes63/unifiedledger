    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge
            variant="outline"
            className="bg-[var(--color-warning)]/20 text-[var(--color-warning)] border-[var(--color-warning)]/30 text-[10px] px-1.5 py-0.5 flex items-center gap-1 cursor-help"
          >
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge
            variant="outline"
            className="bg-[var(--color-warning)]/20 text-[var(--color-warning)] border-[var(--color-warning)]/30 text-[8px] px-1 py-0 flex items-center justify-center cursor-help"
          >
