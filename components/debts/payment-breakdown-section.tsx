                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${isActive
                          ...
                          : 'bg-elevated border-border hover:bg-[var(--color-border)]/20'
                        }
                      `}
                    >
            ...
            <div className="bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/30 rounded-xl p-6 flex flex-col justify-between">
              ...
              <div className="mt-6 space-y-2">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-elevated hover:bg-[var(--color-border)]/20 text-foreground border border-border rounded-lg text-sm font-medium transition-colors"
                >
