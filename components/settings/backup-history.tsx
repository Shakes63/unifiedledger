...
export function BackupHistory() {
  ...
  function getStatusBadge(status: Backup['status']) {
    switch (status) {
      case 'completed':
        return (
          <Badge className="bg-[var(--color-success)] text-white">Completed</Badge>
        );
      case 'pending':
        return (
          <Badge className="bg-[var(--color-warning)] text-white">Pending</Badge>
        );
      case 'failed':
        return (
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              {backup.status === 'failed' && backup.errorMessage && (
                <div className="mt-2 flex items-start gap-2 text-sm text-[var(--color-error)]">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <Button
                ...
                className="border-border text-[var(--color-error)] hover:bg-[var(--color-error)]/10"
              >
