          ...
          <DropdownMenuContent align="end" className="bg-elevated border-border">
            ...
            {onDelete && (
              <DropdownMenuItem
                ...
                className="text-error cursor-pointer hover:bg-error/10"
              >
        ...
        {isCreditAccount ? (
          <>
            ...
            <div>
              ...
              <p className={`text-2xl font-bold font-mono ${hasCredit ? 'text-income' : 'text-error'}`}>
                ${displayBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </p>
              {hasCredit && (
                <p className="text-xs text-income mt-1">Overpayment credit</p>
              )}
            </div>
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-muted-foreground">
                  ...
                  {account.interestType === 'variable' && (
                    <span className="ml-1 text-warning">(Variable)</span>
                  )}
                </span>
              </div>
            )}
            ...
            {account.creditLimit && account.creditLimit > 0 && (
              <>
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className={`font-semibold font-mono ${availableBalance < 0 ? 'text-error' : 'text-income'}`}>
            ...
            {account.includeInPayoffStrategy !== undefined && (
              <div className="flex justify-between items-center text-xs pt-1">
                ...
                <span className={account.includeInPayoffStrategy ? 'text-success' : 'text-muted-foreground opacity-50'}>
