                      ...
                      <div className="flex flex-col items-center gap-0.5">
                        ...
                        {(totals.paidCount > 0 || totals.pendingCount > 0 || totals.overdueCount > 0) && (
                          <div className="flex gap-1">
                            {totals.paidCount > 0 && (
                              <span className="w-2 h-2 rounded-full bg-income" title={`${totals.paidCount} paid`} />
                            )}
                            {totals.pendingCount > 0 && (
                              <span className="w-2 h-2 rounded-full bg-warning" title={`${totals.pendingCount} pending`} />
                            )}
                            {totals.overdueCount > 0 && (
                              <span className="w-2 h-2 rounded-full bg-error" title={`${totals.overdueCount} overdue`} />
                            )}
                          </div>
                        )}
                      </div>
