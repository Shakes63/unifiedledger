...
export function DebtFreeCountdown({ strategyEnabled: propStrategyEnabled, payoffMethod: propPayoffMethod }: DebtFreeCountdownProps) {
  ...
  if (!data.hasDebts) {
    return (
      <div className="bg-gradient-to-br from-income/20 to-income/10 border border-income/30 rounded-xl p-8">
        <div className="text-center">
          <PartyPopper className="w-16 h-16 text-income mx-auto mb-4" />
          <h2 className="text-3xl font-bold text-income mb-2">
            You&apos;re Debt-Free!
          </h2>
          <p className="text-income/80 text-lg">
    ...
    <div className="bg-gradient-to-br from-card to-elevated border border-border rounded-xl p-6 md:p-8">
      ...
      <div className="text-center mb-6">
        <div className="flex items-center justify-center gap-2 mb-2 flex-wrap">
          ...
          <span className="text-xs px-2.5 py-1 rounded-full font-medium capitalize bg-income/20 text-income">
      ...
      {/* Focus Debt Card */}
      {data.focusDebt && (
        <div className="mb-6 bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/30 rounded-xl p-4 md:p-5">
          {/* Focus Header */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <div className="bg-elevated/50 rounded-lg p-3">
              ...
              {data.focusDebt.activePayment > data.focusDebt.currentPayment && (
                <div className="text-xs text-income mt-0.5">
          ...
          {data.nextMilestone && (
            <div className="bg-gradient-to-r from-primary/20 to-primary/10 border border-primary/30 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-primary mb-1">Next Milestone</div>
              ...
              >
                <div
                  className={`transition-all flex justify-center ${
                    milestone.achieved
                      ? 'opacity-100 scale-110 text-income'
                ...
                <div
                  className={`text-xs mt-1 ${
                    milestone.achieved ? 'text-income' : 'text-muted-foreground'
                  }`}
                >
