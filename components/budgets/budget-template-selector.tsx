...
export function BudgetTemplateSelector({
  ...
  const buttonClassName =
    variant === 'page'
      ? 'px-4 py-2 bg-card border border-border text-foreground rounded-lg hover:bg-elevated transition-colors flex items-center gap-1'
      : 'px-4 py-2 bg-card border border-border text-foreground rounded-lg hover:bg-elevated transition-colors text-sm flex items-center gap-1';
      ...
      <Dialog open={isIncomeDialogOpen} onOpenChange={setIsIncomeDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your total monthly income to calculate budget allocations based on this
              template.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <label htmlFor="monthly-income" className="text-sm font-medium text-foreground">
                Monthly Income
              </label>
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 bg-input border border-border rounded-lg px-3 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-(--color-primary)"
                  autoFocus
                />
              </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-2 border-t border-border">
            ...
            <button
              ...
              disabled={applying || !monthlyIncome}
              className="px-4 py-2 bg-(--color-primary) text-white rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2"
            >
              {applying ? (
                <>
