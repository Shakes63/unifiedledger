...
function SuggestionCard({
  ...
  const getConfidenceBadge = (confidence: string, totalScore: number) => {
    if (confidence === 'high') {
      return (
        <Badge className="bg-[var(--color-success)] text-white border-none">
          {totalScore.toFixed(0)}% Match
        </Badge>
      );
    } else if (confidence === 'medium') {
      return (
        <Badge className="bg-[var(--color-warning)] text-white border-none">
          {totalScore.toFixed(0)}% Match
        </Badge>
      );
    } else {
      return (
        <Badge className="bg-[var(--color-error)] text-white border-none">
          {totalScore.toFixed(0)}% Match
        </Badge>
      );
    }
