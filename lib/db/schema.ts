...
export const billInstances = selectSchema(sqlite.billInstances, pg.billInstances);
export const billInstancesRelations = selectSchema(sqlite.billInstancesRelations, pg.billInstancesRelations);
...
export const bills = selectSchema(sqlite.bills, pg.bills);
export const billsRelations = selectSchema(sqlite.billsRelations, pg.billsRelations);
