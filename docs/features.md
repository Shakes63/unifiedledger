...
58. **Unified Debt, Bill & Credit Card Architecture** [IN PROGRESS] - Major refactor to simplify financial obligation tracking. 19 implementation phases. See [Architecture Document](./unified-debt-bill-credit-card-architecture.md) for details.
    ...
    - **Phase 18: Savings-Goals Integration** [COMPLETED 2025-12-04] - Full integration of savings goals with transaction system including auto-detection for savings transfers, transaction goal badges, savings rate tracking with chart/widget, contribution history view, and enhanced savings goals dashboard widget with quick-contribute.
    - **Phase 19: Bill Classification & Subscription Management** [COMPLETED 2025-12-04] - Auto-classification suggestions based on bill name patterns with Apply/Dismiss UI. Classification filter bar on Bills page with icons, counts, and color-coded badges. Bills by Classification dashboard widget with pie chart and click-through navigation. Support for 8 classification types: Subscription, Utility, Housing, Insurance, Loan Payment, Membership, Service, Other.
